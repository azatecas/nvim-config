...
local bundles = {vim.fn.glob(home .. "/java-debug/java-debug/com.microsoft.java.debug.plugin/target/com.microsoft.java.debug.plugin-0.49.0.jar")}
...
local on_attach = function(client, bufnr)
    -- Notify jdtls of Java debug adapter, i think?
    require('jdtls').setup_dap({ hotcodereplace = 'auto' })
    -- the following will launch any configuration available on the project
...
local config = {
  ...
  cmd = {
    home .. "/java/jdk-21.0.1.jdk/Contents/Home",
    ...
    '-jar', vim.fn.glob('/root/eclipse/plugins/org.eclipse.equinox.launcher_1.6.500.v20230717-2134.jar'),

    -- The configuration for jdtls is also placed where jdtls was installed. This will
    -- need to be updated depending on your environment
    '-configuration', '/root/eclipse/config_linux',
